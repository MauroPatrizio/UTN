		...
		<div>
			<Form className="p-4 border rounded m-3">
				...
				<Form.Group controlId="formNombre">
					...
					<Form.Control type="text" name="imagen" placeholder="Ingrese imagen producto" value={values.imagen} onChange={handleChange}></Form.Control>
				</Form.Group>
				<Form.Group controlId="formNombre">
					<Form.Label>Precio</Form.Label>
					<Form.Control type="number" name="precio" placeholder="Ingrese precio producto" value={values.precio} onChange={handleChange}></Form.Control>
				</Form.Group>
